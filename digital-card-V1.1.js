...
//   Updated with improved SEO: meta description, Open Graph, Twitter Card,
//   canonical, JSON-LD (Person + WebSite), preconnect/preload for fonts,
//   and basic favicons. Keep placeholders and replace with your real values
//   before deploying to GitHub/Cloudflare Workers.
// -------------------------------------------
...
export default {
  async fetch(request, env) {
    ...
    const TITLE = 'YOUR | Digital Universe — YOUR_NAME';
    const DESCRIPTION = 'YOUR_NAME (YOUR) — توسعه‌دهنده وب و علاقه‌مند به امنیت سایبری. نمونه‌کارها، لینک‌های اجتماعی و کارت دیجیتال.';
    const TWITTER_HANDLE = '@YOUR_GITHUB_USERNAME';
    const KEYWORDS = 'علیرضا, YOUR, امنیت سایبری, برنامه نویسی, وب, توسعه, نمونه کار';
...
<meta name="author" content="YOUR_NAME (YOUR_GITHUB_USERNAME)" />
...
<meta property="og:image:alt" content="YOUR_NAME (YOUR) — Avatar" />
<meta property="og:site_name" content="YOUR | Digital Universe" />
...
<!-- Icons -->
<link rel="icon" href="${AVATAR_URL}" type="image/jpeg" />
<link rel="apple-touch-icon" href="${AVATAR_URL}" />

<!-- Preconnect / Preload for performance -->
<link rel="preconnect" href="https://fonts.gstatic.com" crossorigin />
<link rel="preconnect" href="https://cdnjs.cloudflare.com" crossorigin />
<link rel="preload" href="https://fonts.googleapis.com/css2?family=Orbitron:wght@400;500;700;900&family=Russo+One&display=swap" as="style" />
  ...
  "@graph": [
    {
      ...
      "image": "${AVATAR_URL}",
      "sameAs": [
        "https://instagram.com/YOUR_GITHUB_USERNAME",
        "https://t.me/YOUR_GITHUB_USERNAME",
        "https://github.com/YOUR_GITHUB_USERNAME",
        "mailto:your.email@example.com"
      ],
      "jobTitle": "Developer / Cybersecurity Enthusiast",
...
<style>
/* ---------- Inline CSS: layout and visuals (unchanged) ---------- */
...
<body>
  ...
  <div class="main-container">
    <div style="width:100%;max-width:1100px;">
      <h1 class="glitch-title" data-text="YOUR">YOUR</h1>
      ...
      <div class="cards-container">
        <a href="javascript:void(0);" class="holo-card link-card" data-app="" data-web="#" data-hint="instagram">
          <div class="icon-wrapper"><div class="icon-face">📷</div></div>
          <h3 class="card-title">Instagram</h3>
        </a>

        <a href="javascript:void(0);" class="holo-card link-card" data-app="" data-web="#" data-hint="telegram">
          <div class="icon-wrapper"><div class="icon-face">✈️</div></div>
          <h3 class="card-title">Telegram</h3>
        </a>

        <a href="javascript:void(0);" class="holo-card link-card" data-app="" data-web="#" data-hint="github">
          <div class="icon-wrapper"><div class="icon-face">💻</div></div>
